  ...
  return (
    <div className="flex h-[100dvh] bg-[#fdfbf7] overflow-hidden text-[13px] relative font-sans">
      ...
      <div className="flex-1 flex flex-col relative w-full h-full overflow-hidden">
        {/* Top Header */}
        <header className="flex items-center justify-between px-4 py-2 sticky top-0 w-full bg-white/90 backdrop-blur-lg z-30 border-b border-stone-100 shadow-sm">
          <div className="flex items-center gap-3">
            <button 
            ...
            <div className="flex flex-col">
              <span className="text-[15px] font-bold text-stone-900 tracking-tight leading-none">Islam.ai</span>
              <span className="text-[10px] text-stone-500 font-medium">Танҳо аз сарчашмаҳои боэътимод</span>
            </div>
          </div>
          <button 
            onClick={startNewChat} 
            className="p-2 hover:bg-stone-100 active:bg-stone-200 rounded-lg transition-colors md:px-4 md:py-2 md:bg-stone-50 md:border md:border-stone-200 md:flex md:items-center md:gap-2"
          >
            <Plus className="w-5 h-5 text-stone-700" />
            <span className="hidden md:inline text-xs font-semibold text-stone-700">Чати нав</span>
          </button>
        </header>
        ...
        {/* Floating Input Bar */}
        <div className="fixed bottom-0 left-0 w-full px-4 pb-3 bg-white/95 backdrop-blur-xl border-t border-stone-100 pt-1.5 z-40">
          <div className="max-w-3xl mx-auto flex flex-col gap-1.5">
            <div className="flex items-center gap-2 bg-stone-100 rounded-xl p-1 shadow-inner border border-stone-200/50 transition-all focus-within:bg-white focus-within:shadow-xl focus-within:border-stone-300">
              <input 
                type="file" 
                ref={fileInputRef} 
              ...
              <button 
                ...
                className="p-1.5 hover:bg-stone-200/50 rounded-lg text-stone-500 transition-colors flex-shrink-0"
              ...
              <input
                ...
                className="flex-1 bg-transparent py-1.5 px-4 border-none focus:ring-0 outline-none text-[14px] sm:text-[15px] text-stone-800 placeholder-stone-400"
              />
              ...
              <div className="flex items-center gap-1.5 pr-1">
                <button
                  ...
                  className="w-9 h-9 flex items-center justify-center bg-stone-900 text-white rounded-lg hover:bg-stone-800 active:scale-90 transition-all disabled:opacity-20 shadow-lg"
                >
